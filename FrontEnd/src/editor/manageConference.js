...
const ManageConference = () => {
    ...
    return (
        <Layout titleheader="Manage Conference Details" titleDescription="Update and Delete" className="container-fluid">
                                ...
                                <div className="col-md-8">
                                    <div className="card mb-5" key={i} style={{border: '2px solid #666'}}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <button className="btn btn-danger" onClick={() => destroyConference(c._id)}>
                                                Delete
                                            </button>
                                        </div>
                                    </div>
